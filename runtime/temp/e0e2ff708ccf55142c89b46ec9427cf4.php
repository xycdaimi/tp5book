<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:70:"A:\wamp64\www\phptp5\public/../application/admin\view\admin\admin.html";i:1702698179;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
                        ...
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item">
                                ...
                                <div class="collapse item-bar" id="book-bar">
                                    ...
                                    <a data-id="#library-frame" data-url="<?php echo $overtime; ?>">超时查询</a>
                                </div>
                            </li>
                            <li class="nav-item">
                                ...
                                <div class="collapse item-bar" id="user-bar">
                                    <a data-id="#library-frame" data-url="<?php echo $users; ?>">用户管理</a>
                                </div>
                            </li>
                            <li class="nav-item">
