<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:71:"A:\wamp64\www\phptp5\public/../application/admin\view\admin\borrow.html";i:1703176087;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
        ...
        <div class="borrow">
            ...
            <div class="info-pane">
                ...
                <div class="user">
                    <h3>用户信息</h3>
                    <form id="borrow-form">
                        <input type="text" name="username" id="username" class="form-control username" placeholder="借阅人用户名">
